    ...
    public class FunctionFilterTests
    {
        ...
        public async Task DoubleFailure()
        {
            ...
            IHost host = new HostBuilder()
                ...
                {
                    services.TryAddEnumerable(ServiceDescriptor.Singleton<IFunctionInvocationFilter>(new MyInvocationFilterAttribute("global")));
                    services.TryAddEnumerable(ServiceDescriptor.Singleton<IFunctionExceptionFilter>(new MyExceptionFilterAttribute("global")));
                })
                .Build();
